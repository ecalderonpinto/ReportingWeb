	...
	public ReportExecution loadAIFMFile(File file,
		...
		if (complexAIFMRecordInfoType.getFilingType() != null) {
			...
			if (reportField != null
					&& temp != null
					&& !temp.isEmpty()
					&& ReportUtilities.searchData(reportDatas, "FilingType",
							"4", null) == null)
				reportDatas.add(new ReportData(null, reportField,
						reportExecution, null, null, temp, null, null, user));
		}
		...
		if (complexAIFMRecordInfoType.getReportingPeriodType() != null) {
			temp = complexAIFMRecordInfoType.getReportingPeriodType().value();
			reportField = ReportUtilities.searchField(reportFields,
		...
		if (complexAIFMRecordInfoType
			...
			temp = complexAIFMRecordInfoType
					.getAIFMReportingObligationChangeFrequencyCode().value();
			reportField = ReportUtilities.searchField(reportFields,
		...
		if (complexAIFMRecordInfoType
			...
			temp = complexAIFMRecordInfoType
					.getAIFMReportingObligationChangeContentsCode().toString();
			reportField = ReportUtilities.searchField(reportFields,
		...
		if (complexAIFMRecordInfoType.getAIFMReportingObligationChangeQuarter() != null) {
			temp = complexAIFMRecordInfoType
		...
		temp = Boolean
				.toString(complexAIFMRecordInfoType.isLastReportingFlag());
		reportField = ReportUtilities.searchField(reportFields,
				"LastReportingFlag", "13");
		if (reportField != null
				&& temp != null
				&& !temp.isEmpty()
				&& ReportUtilities.searchData(reportDatas, "LastReportingFlag",
						"13", null) == null)
			reportDatas.add(new ReportData(null, reportField, reportExecution,
					null, null, temp, null, null, user));
		...
		for (ComplexAssumptionType complexAssumptionType : complexAssumptionTypeList) {
			...
			if (complexAssumptionType.getQuestionNumber() != null) {
				temp = complexAssumptionType.getQuestionNumber().toString();
				reportField = ReportUtilities.searchField(reportFields,
						"QuestionNumber", "14");
				if (reportField != null
						&& temp != null
					...
					reportDatas.add(new ReportData(null, reportField,
							reportExecution, null, null, temp, block, null,
							user));
			}
		...
		if (complexAIFMRecordInfoType.getAIFMReportingCode() != null) {
			temp = complexAIFMRecordInfoType.getAIFMReportingCode().toString();
			reportField = ReportUtilities.searchField(reportFields,
		...
		if (complexAIFMRecordInfoType.getAIFMName() != null) {
			...
			reportField = ReportUtilities.searchField(reportFields, "AIFMName",
					"19");
			if (reportField != null
					&& temp != null
					&& !temp.isEmpty()
		...
		reportField = ReportUtilities.searchField(reportFields, "AIFMEEAFlag",
				"20");
		if (reportField != null
				&& temp != null
				&& !temp.isEmpty()
				&& ReportUtilities.searchData(reportDatas, "AIFMEEAFlag", "20",
						null) == null)
			reportDatas.add(new ReportData(null, reportField, reportExecution,
					null, null, temp, null, null, user));
		...
		for (ComplexFivePrincipalMarketType complexFivePrincipalMarketType : complexFivePrincipalMarketTypeList) {
			...
			if (complexFivePrincipalMarketType.getRanking() != null) {
				temp = complexFivePrincipalMarketType.getRanking().toString();
				reportField = ReportUtilities.searchField(reportFields,
						"Ranking", "26");
				if (reportField != null
						&& temp != null
			...
			// (27) <MarketCodeType>
			if (complexMarketIdentificationWithNOTType.getMarketCodeType() != null) {
			...
			// (28) <MarketCode>
			if (complexMarketIdentificationWithNOTType.getMarketCode() != null) {
				temp = complexMarketIdentificationWithNOTType.getMarketCode();
				reportField = ReportUtilities.searchField(reportFields,
						"MarketCode", "28");
				if (reportField != null
						&& temp != null
			...
			if (complexFivePrincipalMarketType.getAggregatedValueAmount() != null) {
				...
				if (reportField != null
						...
						&& !temp.isEmpty()
						&& ReportUtilities.searchData(reportDatas,
								"AggregatedValueAmount", "29", block) == null)
					reportDatas.add(new ReportData(null, reportField,
							reportExecution, null, null, temp, block, null,
							user));
			}
		...
		for (ComplexPrincipalInstrumentType complexPrincipalInstrumentType : complexPrincipalInstrumentTypeList) {
			...
			if (complexPrincipalInstrumentType.getRanking() != null) {
				temp = complexPrincipalInstrumentType.getRanking().toString();
				reportField = ReportUtilities.searchField(reportFields,
						"Ranking", "30");
				if (reportField != null
						&& temp != null
			...
			if (complexPrincipalInstrumentType.getSubAssetType() != null) {
				temp = complexPrincipalInstrumentType.getSubAssetType().value();
				reportField = ReportUtilities.searchField(reportFields,
						"SubAssetType", "31");
				if (reportField != null
						&& temp != null
			...
			if (complexPrincipalInstrumentType.getAggregatedValueAmount() != null) {
				...
				if (reportField != null
						...
						&& !temp.isEmpty()
						&& ReportUtilities.searchData(reportDatas,
								"AggregatedValueAmount", "32", block) == null)
					reportDatas.add(new ReportData(null, reportField,
							reportExecution, null, null, temp, block, null,
							user));
			}
		...
		if (complexAIFMNationalIdentifierType != null) {
			...
			if (complexAIFMNationalIdentifierType.getReportingMemberState() != null) {
			...
			if (complexAIFMNationalIdentifierType.getAIFMNationalCode() != null) {
				temp = complexAIFMNationalIdentifierType.getAIFMNationalCode();
				reportField = ReportUtilities.searchField(reportFields,
						"Old_AIFMNationalCode", "25");
				if (reportField != null
						&& temp != null
						&& !temp.isEmpty()
						&& ReportUtilities.searchData(reportDatas,
		...
		if (complexAIFMCompleteDescriptionType.getAUMAmountInEuro() != null) {
			temp = complexAIFMCompleteDescriptionType.getAUMAmountInEuro()
					.toString();
			reportField = ReportUtilities.searchField(reportFields,
					"AUMAmountInEuro", "33");
			if (reportField != null
		...
		if (complexBaseCurrencyDescriptionType.getAUMAmountInBaseCurrency() != null) {
		...
		if (complexBaseCurrencyDescriptionType.getBaseCurrency() != null) {
			temp = complexBaseCurrencyDescriptionType.getBaseCurrency();
			reportField = ReportUtilities.searchField(reportFields,
					"BaseCurrency", "35");
			if (reportField != null
					&& temp != null
					&& !temp.isEmpty()
					&& ReportUtilities.searchData(reportDatas, "BaseCurrency",
							"35", null) == null)
				reportDatas.add(new ReportData(null, reportField,
						reportExecution, null, null, temp, null, null, user));
		}
		...
		if (complexBaseCurrencyDescriptionType.getFXEURReferenceRateType() != null) {
			temp = complexBaseCurrencyDescriptionType
		...
		if (complexBaseCurrencyDescriptionType.getFXEURRate() != null) {
			temp = complexBaseCurrencyDescriptionType.getFXEURRate().toString();
			reportField = ReportUtilities.searchField(reportFields,
					"FXEURRate", "37");
			if (reportField != null
					&& temp != null
